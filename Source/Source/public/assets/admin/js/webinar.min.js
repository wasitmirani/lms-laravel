(function ($) {
  ...
  * */
  ...
  $('body').on('click', '#webinarAddSession', function (e) {
    ...
    var modal = $('#webinarSessionModal');
    modal.find('input').prop('disabled', false);
    var add_session_modal = '<div id="addSessionModal">';
  ...
  $('body').on('click', '#savePrerequisites', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $('#addPrerequisitesModal form');
    handleWebinarItemForm(form, $this);
  });
  /**
   * add webinar FAQ
  ...
  * */
  ...
  $('body').on('click', '#webinarAddTestLesson', function (e) {
    e.preventDefault();
    var nameId = randomString();
    var addTextLesson = '<div id="addTestLessonModal">';
  ...
  $('body').on('click', '#saveTestLesson', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $('#addTestLessonModal form');
    handleWebinarItemForm(form, $this);
  });
  $('body').on('click', '.edit-test-lesson', function (e) {
    ...
    $.post('/admin/test-lesson/' + id + '/edit', edit_data, function (result) {
      if (result && result.testLesson) {
        var testLesson = result.testLesson;
        var nameId = randomString();
        var addTextLesson = '<div id="addTestLessonModal">';
        addTextLesson += $('#webinarTestLessonModal').html();
        addTextLesson += '</div>';
        ...
        Swal.fire({
          ...
          onOpen: function onOpen() {
            var $modal = $('#addTestLessonModal');
            var attachments = [];
            Object.keys(testLesson).forEach(function (key) {
              if (key === 'attachments') {
                if (testLesson[key] && testLesson[key].length) {
                  Object.keys(testLesson[key]).forEach(function (k) {
