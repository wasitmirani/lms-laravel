(function ($) {
  ...
  $('body').on('click', '.js-play-video', function (e) {
    ...
    var $modal = $('#playVideo');
    var $modalLoading = $modal.find('.loading-img');
    ...
    var file_title = $(this).closest('.accordion-row').find('.file-title').text();
